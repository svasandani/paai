		...
		public static function defaults() {
			...
			return apply_filters(
				...
				array(
					...
					'footer-sml-section-1-credit'          => __( 'Copyright &copy; [current_year] [site_title]', 'astra' ),
					'footer-sml-section-2'                 => '',
					'footer-sml-section-2-credit'          => __( 'Copyright &copy; [current_year] [site_title]', 'astra' ),
